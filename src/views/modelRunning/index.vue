<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务编号" align="center" prop="postCode" />
      <el-table-column label="任务名称" align="center" prop="postName" />
      <el-table-column label="模型名称" align="center" prop="postSort" />
      ...
      <el-table-column label="执行进度" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_normal_disable" :value="scope.row.status"/>
        </template>
      </el-table-column>
      <el-table-column label="线索数量" align="center" prop="postSort" />
